 ...
 * Recursive component for rendering file tree nodes with expand/collapse functionality
 */
...
export const FileTreeNodeComponent = memo(function FileTreeNodeComponent({
  ...
  if (node.type === 'file') {
    return (
      <div
        className={cn(
          "flex items-center justify-between px-3 py-2 hover:bg-accent/10 cursor-pointer transition-colors group",
          "text-sm"
        )}
