...
const statusConfig: Record<ReportStatus, { color: string; text: string }> = {
...
export function AdminGovernancePanel() {
  ...
  const [activeTab, setActiveTab] = useState<
    "reports" | "hidden" | "namespaces" | "promotions"
  >("reports");
  const [selectedReport, setSelectedReport] = useState<SkillReport | null>(
    null,
  );
    ...
    <div className="p-6">
      ...
      >
        <Tabs
          ...
          onChange={(key) =>
            setActiveTab(
              key as "reports" | "hidden" | "namespaces" | "promotions",
            )
          }
          items={[
            {
