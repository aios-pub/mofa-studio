  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center justify-between p-6 border-b border-[var(--color-border)]">
        <div>
          <h1 className="text-xl font-semibold text-[var(--color-text-primary)]">实时监控</h1>
          <p className="text-sm text-[var(--color-text-secondary)]">监控 Agent 状态和系统运行情况</p>
        </div>
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2">
                <span className="font-medium text-[var(--color-text-primary)]">{alert.title}</span>
                {alert.acknowledged && (
