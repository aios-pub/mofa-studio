                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs text-[var(--color-text-tertiary)]">
                        {t('profile.avatarHint', '支持 JPG、PNG 格式，大小不超过 2MB')}
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 rounded-lg border border-[var(--color-border)] bg-[var(--color-bg-base)] text-[var(--color-text-primary)] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
                    />
                  </div>
